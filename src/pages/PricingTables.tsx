...
export default function PricingTables() {
  return (
    <div>
      <PageMeta
        title="React.js Pricing Dashboard | MyHermes - Next.js Admin Dashboard Template"
        description="This is React.js Pricing Dashboard page for MyHermes - React.js Tailwind CSS Admin Dashboard Template"
      />
