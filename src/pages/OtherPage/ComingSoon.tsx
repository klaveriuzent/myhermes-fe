...
export default function ComingSoon() {
  ...
  return (
    <>
      <PageMeta
        title="React.js Coming Soon Dashboard | MyHermes - React.js Admin Dashboard Template"
        description="This is React.js Coming Soon  Dashboard page for MyHermes - React.js Tailwind CSS Admin Dashboard Template"
      />
