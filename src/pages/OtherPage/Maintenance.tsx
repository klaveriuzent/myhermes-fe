...
export default function Maintenance() {
  return (
    <>
      <PageMeta
        title="React.js Maintenance Dashboard | MyHermes - React.js Admin Dashboard Template"
        description="This is React.js Maintenance Dashboard page for MyHermes - React.js Tailwind CSS Admin Dashboard Template"
      />
      <div className="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1">
        ...
        <p className="absolute text-sm text-center text-gray-500 -translate-x-1/2 bottom-6 left-1/2 dark:text-gray-400">
          &copy; {new Date().getFullYear()} - MyHermes
        </p>
      </div>
      <div className="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1">
        <GridShape />
