...
export default function Success() {
  return (
    <>
      <PageMeta
        title="React.js Success Dashboard | MyHermes - React.js Admin Dashboard Template"
        description="This is React.js Success Dashboard page for MyHermes - React.js Tailwind CSS Admin Dashboard Template"
      />
