...
export default function Faqs() {
  return (
    <>
      <PageMeta
        title="React.js Faqs Dashboard | MyHermes - Next.js Admin Dashboard Template"
        description="This is React.js Faqs Dashboard page for MyHermes - React.js Tailwind CSS Admin Dashboard Template"
      />
