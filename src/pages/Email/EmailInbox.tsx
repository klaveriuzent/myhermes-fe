...
export default function EmailInbox() {
  return (
    <>
      <PageMeta
        title="React.js Inbox Dashboard | MyHermes - React.js Admin Dashboard Template"
        description="This is React.js Inbox Dashboard page for MyHermes - React.js Tailwind CSS Admin Dashboard Template"
      />
