...
export default function BasicTables() {
  return (
    <>
      <PageMeta
        title="React.js Basic Tables Dashboard | MyHermes - Next.js Admin Dashboard Template"
        description="This is React.js Basic Tables Dashboard page for MyHermes - React.js Tailwind CSS Admin Dashboard Template"
      />
