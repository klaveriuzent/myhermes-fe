...
export default function DataTables() {
  return (
    <>
      <PageMeta
        title="React.js Data Tables Dashboard | MyHermes - Next.js Admin Dashboard Template"
        description="This is React.js Data Tables Dashboard page for MyHermes - React.js Tailwind CSS Admin Dashboard Template"
      />
