...
export default function Carousel() {
  return (
    <>
      <PageMeta
        title="React.js Carousel Dashboard | MyHermes - React.js Admin Dashboard Template"
        description="This is React.js Carousel Dashboard page for MyHermes - React.js Tailwind CSS Admin Dashboard Template"
      />
