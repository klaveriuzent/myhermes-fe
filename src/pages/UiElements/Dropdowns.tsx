...
export default function Dropdowns() {
  return (
    <div>
      <PageMeta
        title="React.js Dropdowns Dashboard | MyHermes - React.js Admin Dashboard Template"
        description="This is React.js Dropdowns Dashboard page for MyHermes - React.js Tailwind CSS Admin Dashboard Template"
      />
