...
export default function Notifications() {
  ...
  return (
    <>
      <PageMeta
        title="React.js  Notifications | MyHermes - React.js Admin Dashboard Template"
        description="This is React.js Notifications  page for MyHermes - React.js Tailwind CSS Admin Dashboard Template"
      />
