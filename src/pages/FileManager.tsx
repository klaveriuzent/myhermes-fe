...
export default function FileManager() {
  return (
    <>
      <PageMeta
        title="React.js File Manager Dashboard | MyHermes - Next.js Admin Dashboard Template"
        description="This is React.js File Manager Dashboard page for MyHermes - React.js Tailwind CSS Admin Dashboard Template"
      />
